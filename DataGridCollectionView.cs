...
namespace FastListCollectionView
{
    /// <summary>
    ...
    /// </summary>
    public sealed class DataGridCollectionView : ListCollectionView, IDataGridCollectionView, IDataGridEditableCollectionView, IList, INotifyPropertyChanged, System.ComponentModel.IItemProperties, IEditableCollectionViewAddNewItem
    {
        /// <summary>
        ...
        public DataGridCollectionView(IList source)
            : this(source, false /*isDataSorted*/, false /*isDataInGroupOrder*/)
        {
            Ite = new ObservableCollection<ItemPropertyInfo>(this[0].GetType().GetProperties().Select(w => new ItemPropertyInfo(w.Name, w.PropertyType, GetPropertyDescriptor(w))));
        }
        ...
        public DataGridCollectionView(IList source, bool isDataSorted, bool isDataInGroupOrder) : base(source)
        {
        ...
        {
            return TypeDescriptor.GetProperties(PropertyInfo.DeclaringType).Find(PropertyInfo.Name, false);//.Item(PropertyInfo.Name);
        }
        /// <summary>
        ...
        /// </summary>
        //public override IReadOnlyList<object> Groups
        public override ReadOnlyObservableCollection<object> Groups
        {
            get
            {
                ...
                return new ReadOnlyObservableCollection<object>(new ObservableCollection<object>(RootGroup?.Items));
            }
        }
        ...
        private ObservableCollection<ItemPropertyInfo> Ite;
        public ReadOnlyCollection<ItemPropertyInfo> ItemProperties { get => new ReadOnlyCollection<ItemPropertyInfo>(Ite); }
        ...
        private static object InvokePath(object item, string propertyPath, Type propertyType)
        {
            ...
            var accessor = TypeAccessor.Create(item?.GetType());
            object propertyValue = accessor[item, propertyPath];//TypeHelper.GetNestedPropertyValue(item, propertyPath, propertyType, out Exception exception);
            //if (exception != null)
            //{
            //    throw exception;
            //}
