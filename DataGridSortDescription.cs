...
namespace FastListCollectionView
{
    public abstract class DataGridSortDescription
    {
        ...
        private class DataGridPathSortDescription : DataGridSortDescription
        {
            ...
            {
                return o.GetType().GetProperties().FirstOrDefault(x => x.Name == _propertyPath).PropertyType;
            }
            ...
            internal override void Initialize(Type itemType)
            {
                ...
                if (_propertyType == null)
                    _propertyType = itemType.GetProperties().FirstOrDefault(x => x.Name == _propertyPath).PropertyType;
